          ...
          <div className="max-w-md w-full mx-auto p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                We're sorry, but something unexpected happened. Please try refreshing the page or go back to continue browsing.
              </p>
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="mt-6 text-left">
                  ...
                  <pre className="mt-2 p-3 bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-200 text-xs rounded overflow-auto">
